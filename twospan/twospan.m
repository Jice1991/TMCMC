...
load s2_2span
%% measurement
n = 30; % problem dimension = No. parameters
y.n = n;
...
figure(3)
plot(x(1:end,2),'m-','LineWidth',1); 
    hold on
plot(x(1:end,6),'g-','LineWidth',1); 
    hold on
plot(x(1:end,13),'y-','LineWidth',1); 
    hold on
plot(x(1:end,19),'k-','LineWidth',1); 
hold on
plot(x(1:end,24),'c-','LineWidth',1); 
    hold on
plot(x(1:end,28),'b-','LineWidth',1); 
    hold on
...
for i=1:30
    ...
    hold on
    elseif i==24
            plot(x(1:end,i),'c-','LineWidth',1); 
    hold on
    elseif i==28
            plot(x(1:end,i),'r-','LineWidth',1); 
    hold on
    else 
